...
const CardComments = ({post}) =>{
    const [text, setText] = useState(""); // variable dans laquelle on va stocker notre commentaire
            ...
            {post.comments.map((comment)=>{
                return(
                    <div className={comment.commenterId === userData._id ?
                        "comment-container client" : "comment-container"} key={
                            comment._id}>
